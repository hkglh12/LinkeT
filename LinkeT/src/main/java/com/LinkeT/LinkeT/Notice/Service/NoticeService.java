...
public interface NoticeService {
	...
	/* create */
	public boolean createNotice(int teamNoticeSerial, String teamCode, String usrId, String noticeTitle, String noticeContent, String noticeFileCode1, String noticeFileCode2);
	/* Listing */
