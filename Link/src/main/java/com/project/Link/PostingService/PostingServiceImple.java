...
public class PostingServiceImple implements PostingService {
	...
	public PostingServiceImple(){}
	
	
	public PostingDao getpDao() {
		return pDao;
	}


	public void setpDao(PostingDao pDao) {
		this.pDao = pDao;
	}
	...
	public int getCount(String targetBoard, String prefix,int serial) {
		int result = pDao.get(targetBoard, prefix, serial);
		return result;
	}

	@Override
	public int updateCount(String targetBoard,String prefix, int count, int serial) {
		int result = pDao.update(targetBoard,prefix,count, serial);
		return result;
	}
