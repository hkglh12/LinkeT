...
public interface NoticementController {
	...
	/* 공지사항작성 */
	public String PostNoticement(Model model, HttpServletRequest reqeust, HttpSession session, RedirectAttributes redirectAttr);	
	/* 공지사항조회 */
	public String GetNoticement(Model model, HttpServletRequest reqeust, HttpSession session, RedirectAttributes redirectAttr);
	/* 공지사항업데이트 */
	public String UpdateNoticement(Model model, HttpServletRequest reqeust, HttpSession session, RedirectAttributes redirectAttr);
	/* 공지사항삭제 */
