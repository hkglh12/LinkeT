...
<head>
    ...
    <script src="${pageContext.request.contextPath}/a/js/User/comment/board.js"></script>
    <link href="${pageContext.request.contextPath}/a/css/User/comment/board.css" rel="stylesheet">
